...
function App() {
  ...
  useEffect(() => {
    const apiUrl = `https://api.weatherapi.com/v1/current.json?key=${process.env.API_KEY}&q=${city}&aqi=no;`;
  ...
  return (
    <div className="bg-gray-400 h-screen flex justify-center  items-start">
